...
You can choose to only download the [Examples repository](https://github.com/SmartThingsCommunity/st-device-sdk-c-ref) from git, if you have already ported your project. The `IoT core device library` is downloaded as a submodule in the [Examples repository](https://github.com/SmartThingsCommunity/st-device-sdk-c-ref).
...
In order for your IoT device to connect to the SmartThings Cloud, there are authentication data files required.
...
$
$ ./stdk-keygen -m fAAA                  # replace fAAA with your MNID
...
Public Key:
NDajrgf1RYIljB6rQD15cGroNWRcFzc0TPX0bmSTcBc=
$
$ tree
.
├── ed25519.pubkey
├── ed25519.seckey
└── output_STDKfAAA26de760a
    └── device_info.json
```
...
1. Device Identity
   ...
   - Individual developer
     ...
     **[For ED25519]**
     ...
     If you create a device identity with a command with an option like `./stdk-keygen -m fAAA -f V201910` like the first phase,  you can get the ready-to-use device_info.json file directly.
     ...
     $ cat output_STDKfAAA26de760a/device_info.json
     {
       "deviceInfo": {
         "firmwareVersion": "V201910",
         "privateKey": "ggSeOW7xLLWSYUUKcFjfStJOwLY5lzZOm8F3a+olAWs=",
         "publicKey": "NDajrgf1RYIljB6rQD15cGroNWRcFzc0TPX0bmSTcBc=",
         "serialNumber": "STDKfAAA26de760a"
       }
     }
     ```
...
4. Control & Monitor a device
   ...
   <img src="res/added_device.jpg" style="zoom:50%;" align="left"/>
