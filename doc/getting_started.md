...
- [IoT Core Device Library](https://github.com/SmartThingsCommunity/st-device-sdk-c/tree/release/v1.4)
- [Reference](https://github.com/SmartThingsCommunity/st-device-sdk-c-ref/tree/release/v1.4)

#### Download Reference

You can just choose to download the [Reference repository](https://github.com/SmartThingsCommunity/st-device-sdk-c-ref/tree/release/v1.4) from GitHub, if you use a chipset that has already been ported. In this case, the `IoT Core Device Library` and `a chipset SDK` can be easily downloaded as submodules in this Reference repository through the predefined `setup.py` script. If you are new for using the _SmartThings SDK for Direct Connected Devices_, we recommend you to use the [Reference repository](https://github.com/SmartThingsCommunity/st-device-sdk-c-ref/tree/release/v1.4) for easier understanding.
...
1. device_info.json
   ...
   - **All inclusive**
     ...
     ```
     This file can be generated by [stdk-keygen.py](https://github.com/SmartThingsCommunity/st-device-sdk-c/tree/release/v1.4/tools/keygen#individual) like below example.
     ```sh
   ...
   - **Firmware version only**
     ...
     [stdk-keygen.py](https://github.com/SmartThingsCommunity/st-device-sdk-c/tree/release/v1.4/tools/keygen#commercial) also supports batch creation by reading csv formatted series of device serial number.
