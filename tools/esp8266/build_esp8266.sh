...
print_usage () {
  echo "    Usage: ./build.sh PROJECT_NAME [make_option]"
  echo "- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -"
  echo "    ex) ./build.sh smart_switch"
  echo "    ex) ./build.sh smart_switch clean"
  echo "    ex) ./build.sh smart_switch flash"
  echo "    ex) ./build.sh smart_switch monitor"
  echo "    ex) ./build.sh smart_switch flash monitor"
  echo
}
