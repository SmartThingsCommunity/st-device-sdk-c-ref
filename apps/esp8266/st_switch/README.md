...
By default, You can modify GPIO pin settings in `~/st-device-sdk-c-ref/apps/esp8266/st_switch/main/device_control.h`. 
...
Also, multiple options can be used simultaneously like `./build.sh esp8266 st_switch flash monitor`.
