...
typedef struct caps_thermostatMode_data {
    ...
    int supportedThermostatModes_array_size;
    const char **(*get_supportedThermostatModes_value)(struct caps_thermostatMode_data *caps_data);
    void (*set_supportedThermostatModes_value)(struct caps_thermostatMode_data *caps_data, const char **value, int array_size);
