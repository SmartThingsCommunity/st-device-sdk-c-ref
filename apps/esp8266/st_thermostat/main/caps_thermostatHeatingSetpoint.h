...
typedef struct caps_thermostatHeatingSetpoint_data {
    ...
    int heatingSetpoint_value;
    int (*get_heatingSetpoint_value)(struct caps_thermostatHeatingSetpoint_data *caps_data);
    void (*set_heatingSetpoint_value)(struct caps_thermostatHeatingSetpoint_data *caps_data, int value);
