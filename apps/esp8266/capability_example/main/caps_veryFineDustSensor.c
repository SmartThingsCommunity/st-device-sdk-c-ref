...
static void caps_veryFineDustSensor_attr_veryFineDustLevel_send(caps_veryFineDustSensor_data_t *caps_data)
{
    ...
    cap_evt = st_cap_attr_create_int((char *) caps_helper_veryFineDustSensor.attr_veryFineDustLevel.name, caps_data->veryFineDustLevel_value, caps_data->veryFineDustLevel_unit);
    if (!cap_evt) {
