...
static void caps_thermostatHeatingSetpoint_attr_heatingSetpoint_send(caps_thermostatHeatingSetpoint_data_t *caps_data)
{
    ...
    cap_evt = st_cap_attr_create_number((char *) caps_helper_thermostatHeatingSetpoint.attr_heatingSetpoint.name, caps_data->heatingSetpoint_value, caps_data->heatingSetpoint_unit);
    if (!cap_evt) {
