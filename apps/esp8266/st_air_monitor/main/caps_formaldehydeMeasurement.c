...
static void caps_formaldehydeMeasurement_attr_formaldehydeLevel_send(caps_formaldehydeMeasurement_data_t *caps_data)
{
    ...
    cap_evt = st_cap_attr_create_number((char *) caps_helper_formaldehydeMeasurement.attr_formaldehydeLevel.name, caps_data->formaldehydeLevel_value, caps_data->formaldehydeLevel_unit);
    if (!cap_evt) {
