...
## STDK config
If you want to use specific STDK build options, you can directly modify the build configuration file. For esp8266 example, STDK config is saved in 'sdkconfig' file. If you want to change this, please execute the following :
```sh
